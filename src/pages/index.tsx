  ...
  return (
    <>
      ...
      <main className={styles.main}>
        ...
        <section className={styles.preview} data-testid="home-page">
          <div className={styles.previewContainer}>
            <div className={styles.previewContent}>
              <div className={styles.previewText}>
                ...
                <Button onClick={clickHandler} type={"primary"} data-testid="get-call-btn">Get call</Button>
              </div>
        ...
        <section className={styles.call}>
          <div className={styles.callContent}>
            <div className={styles.callImg}>
              <Image src={CallImg} alt={"CallImg"} loading="lazy" />
            </div>
